...
# Images
imgb = pygame.image.load('cub/1.png')
imgg = pygame.image.load('cub/2.png')
imgp = pygame.image.load('cub/3.png')
imgr = pygame.image.load('cub/4.png')
    ...
    for x in range(ROWS):
        for y in range(COLS):
            if tetris.board[x][y] > 0:
                ...
                cub = CUBS[val]
                win.blit(cub, (y * CELLSIZE, x * CELLSIZE))
